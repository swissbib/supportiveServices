 ...
 * Time: 09:20:59
 */
public class AvailabilityFilter extends AlephStreamFilter{
    ...
    public AvailabilityFilter(String sysnumber, String[] barcodes, Institution institution) {
        super(sysnumber);
            ...
            switch (eventType) {
                ...
                case XMLStreamConstants.START_ELEMENT:
                    ...
                    if (name.equalsIgnoreCase("circ-status")) {
                        ...
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("due-hour") && this.circItem != null) {
                        this.circItem.setDueHour(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("no-requests") && this.circItem != null) {
                        this.circItem.setNumberRequests(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("barcode") && this.circItem != null) {

                        this.circItem.setIdentifierBarcode(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("z30-description") && this.circItem != null) {

                        this.circItem.setZ30description(reader.getElementText());
                        toParse = true;
                        ...
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("collection") && this.circItem != null) {

                        this.circItem.setCollection(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("location") && this.circItem != null) {

                        this.circItem.setLocation(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("pages") && this.circItem != null) {

                        this.circItem.setPages(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("location-2") && this.circItem != null) {

                        this.circItem.setLocation2(reader.getElementText());
                        toParse = true;
                    } else if (this.rootCircStatus && name.equalsIgnoreCase("opac-note") && this.circItem != null) {

                        this.circItem.setOpacnote(reader.getElementText());
                        toParse = true;
    ...
    protected boolean isBarcodeRequested(String barcode) {
        ...
        for (String tempB : this.barcodes) {
